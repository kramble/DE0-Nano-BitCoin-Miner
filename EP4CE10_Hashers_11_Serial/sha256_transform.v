...
module sha256_transform #(
	...
	generate
		...
		for (i = 0; i < NUM_HASHERS; i = i + 1) begin : HASHERS
			...
			reg [4:0] cur_seq = 0;	// See note above
			...
			assign K_next = K_next_tbl[cur_seq[2:0]];	// LS bits of seq used to index K_next_tbl
	...
	begin
		...
		tx_fullhash <= (HASHERS[NUM_HASHERS-6'd3].state[`IDX(7)] == 32'ha41f32e7);	// Explicit value
	end
